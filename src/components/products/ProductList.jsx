...
function ProductList() {
  return (
    <section className="w-full px-16 py-8 overflow-x-auto overflow-y-auto min-h-[400px]">
      <div className="flex justify-between items-center">
        <h2 className="font-normal text-base text-[24px] leading-relaxed text-gray-700">
          Featured sets
        </h2>
