...
export async function POST(request: Response) {
    const { email, imageUrl, name, surname, address, phone } = await request.json();
...
function isParameterValid(email: string, name: string, surname: string, address: string, phone: string): boolean {
