    ...
    return (
        <div className="w-[60vw] m-auto flex flex-col sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
                ...
                <form>
                    <div className="space-y-4">
                        <div>
                            ...
                            <input id="cardNumber" type="text" placeholder="4111 1111 1111 1111" required />
                        </div>
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <label htmlFor="saveCard" className="text-sm font-medium text-gray-500 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg shadow-lg p-6 sm:p-8 lg:p-10 col-span-1 lg:col-span-2">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6">Billing & Shipping Information</h2>
                <form>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="col-span-1 sm:col-span-2">
                            <div className="flex items-start gap-2">
                                ...
                                <label htmlFor="sameAsShipping" className="text-sm font-medium text-gray-500 dark:text-gray-400">
